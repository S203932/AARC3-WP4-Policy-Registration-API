...
minimumPolicy = '''{"policy":{"augment_policy_uris":null,"aut":null,"aut_name":"Sicherheit fur dich","contacts":[{"email":"Max.Jurgen@hochschule.de","type":"standard"}],"id":"urn:som:654321","includes_policy_uris":null,"notice_refresh_period":null,"policy_class":"privacy","policy_jurisdiction":null,"policy_url":null,"ttl":null,"valid_from":null}}\n'''
...
anotherPolicy = '''{"policy":{"augment_policy_uris":["https://documents.egi.eu/document/2623"],"aut":"https://cern.ch","aut_name":"CERN","aut_name#dk_DK":"CERN","contacts":[{"email":"notSupicious@mikrosoft.xyz","type":"standard"}],"description":"A research community beyond suspicion.","description#dk_DK":"Et trovaerdigt forsknings institut.","id":"https://another-community.org","includes_policy_uris":["https://some-community.org","https://wise-community.org/wise-baseline-aup/v1/"],"notice_refresh_period":null,"policy_class":"sla","policy_jurisdiction":null,"policy_url":"https://another-community.org","ttl":31104300,"valid_from":"2019-06-10T23:59:59Z"}}\n'''

thePolicy = '''{"policy":{"augment_policy_uris":["urn:doi:10.60953/68611c23-ccc7-4199-96fe-74a7e6021815"],"aut":null,"aut_name#dk_DK":"Auto sikkerhed","contacts":[{"email":"friend@gov.org","type":"standard"}],"id":"urn:idk:123456","includes_policy_uris":["https://another-community.org"],"notice_refresh_period":259200,"policy_class":"conditions","policy_jurisdiction":null,"policy_url":"https://the-community.org","ttl":604800,"valid_from":"2025-05-01T18:00:00Z"}}\n'''
